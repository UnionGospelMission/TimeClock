...
class ClockInOut(AbstractRenderer, AbstractHideable):
    ...
    def clockIn(self, sub, wloc):
        self.employee.getAPI().clockIn(sub, wloc)
        e = TimeEntryCreatedEvent(self.employee.timeEntry)
    ...
    @Transaction
    def clockOut(self):
        te = self.employee.timeEntry
        self.employee.getAPI().clockOut(self.employee)
